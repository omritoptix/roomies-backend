...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Roomie.apartment'
        db.alter_column(u'roomies_backend_app_roomie', 'apartment_id', self.gf('django.db.models.fields.related.ForeignKey')(default='null', to=orm['roomies_backend_app.Apartment']))
