...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoomieBillItem.amountPaid'
        db.add_column(u'roomies_backend_app_roomiebillitem', 'amountPaid',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoomieBillItem.amountPaid'
        db.delete_column(u'roomies_backend_app_roomiebillitem', 'amountPaid')
