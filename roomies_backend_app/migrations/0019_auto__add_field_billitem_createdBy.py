...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BillItem.createdBy'
        db.add_column(u'roomies_backend_app_billitem', 'createdBy',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=12, related_name='createdBy', to=orm['roomies_backend_app.Roomie']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BillItem.createdBy'
        db.delete_column(u'roomies_backend_app_billitem', 'createdBy_id')
