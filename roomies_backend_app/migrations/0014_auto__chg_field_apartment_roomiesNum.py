...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Apartment.roomiesNum'
        db.alter_column(u'roomies_backend_app_apartment', 'roomiesNum', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Apartment.roomiesNum'
        db.alter_column(u'roomies_backend_app_apartment', 'roomiesNum', self.gf('django.db.models.fields.IntegerField')(default=4))
